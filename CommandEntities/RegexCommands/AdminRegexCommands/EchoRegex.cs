    ...
    class EchoRegex : RegexCommand
    {
        ...
        public override async Task ExecuteAsync(Message message, ITelegramBotClient client)
        {
            ...
            if (message.Photo != null)
            {
                ...
                await client.TrySendPhotoAsync(message.Chat.Id, inputFile, sendMessage, Telegram.Bot.Types.Enums.ParseMode.Html);
            }
            else if (message.Audio != null)
            {
                ...
                await client.TrySendAudioAsync(message.Chat.Id, inputFile, sendMessage, Telegram.Bot.Types.Enums.ParseMode.Html, message.Audio.Duration, message.Audio.Performer, message.Audio.Title, false, 0, null, default, inputFileThumb);
            }
            else if (message.Video != null)
            {
                ...
                await client.TrySendVideoAsync(message.Chat.Id, inputFile, message.Video.Duration, message.Video.Width, message.Video.Height, sendMessage, Telegram.Bot.Types.Enums.ParseMode.Html, false, false, 0, null, default, inputFileThumb);
            }
            else if (message.Animation != null)
            {
                ...
                await client.TrySendAnimationAsync(message.Chat.Id, inputFile, message.Animation.Duration, message.Animation.Width, message.Animation.Height, inputFileThumb, sendMessage, Telegram.Bot.Types.Enums.ParseMode.Html);
            }
            else if (message.Text != null && !string.IsNullOrEmpty(sendMessage))
            {
                await client.TrySendTextMessageAsync(message.Chat.Id, sendMessage, Telegram.Bot.Types.Enums.ParseMode.Html);
            }
